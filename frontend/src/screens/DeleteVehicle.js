...
export default class DeleteVehicle extends Component {
    ...
    onSubmit = (e) => {
        ...
        Axios.delete("http://ec2-54-226-153-212.compute-1.amazonaws.com:8081/vehicle/"+vehicle_id).then((response) => {
            if (response.data) {
                alert(
                    "Vehicle Deleted!"
                );
                        ...
                        <div>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        name='vehicle_type'
                                        value={this.state.vehicle.vehicle_type}
                                        onChange={this.onChange}
                                        type="text"
                                        className="form-control"
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        name='vehicle_number'
                                        value={this.state.vehicle.vehicle_number}
                                        onChange={this.onChange}
                                        type="text"
                                        className="form-control"
