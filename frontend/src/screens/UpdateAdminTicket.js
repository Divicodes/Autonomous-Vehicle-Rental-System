...
export default class UpdateAdminTicket extends Component {
    ...
    onSubmit = (e) => {
        ...
        Axios.post("http://ec2-54-226-153-212.compute-1.amazonaws.com:8081/ticket/update", data).then((response) => {
            if (response.data) {
                alert(
                    "Ticket Updated!"
                );
                        ...
                        <div>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        name='reporter_id'
                                        defaultValue={this.state.ticket.reporter_id}
                                        onChange={this.onChange}
                                        type="text"
                                        className="form-control"
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        name='time_created'
                                        defaultValue={this.state.ticket.time_created}
                                        onChange={this.onChange}
                                        type="text"
                                        className="form-control"
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        name = "time_closed"
                                        defaultValue={this.state.ticket.time_closed}
                                        onChange={this.onChange}
                                        type="text"
                                        className="form-control"
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        name = "comments"
                                        defaultValue={this.state.ticket.comments}
                                        onChange={this.onChange}
                                        type="text"
                                        className="form-control"
